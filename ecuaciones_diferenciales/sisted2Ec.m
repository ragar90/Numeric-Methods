...
for j=1:n
    ...
    for i=1:m
        if j==1
            k1i(i)=h*subs(fi{i},{t,x,y},{ti(j),wi0(1),wi0(2)});
        else
            k1i(i)=h*subs(fi{i},{t,x,y},{ti(j),wij(1,j-1),wij(2,j-1)});
        end
    ...
    for i=1:m
        if j==1
            k2i(i)=h*subs(fi{i},{t,x,y},{ti(j)+h/2,wi0(1)+1/2*k1i(1),wi0(2)+1/2*k1i(2)});
        else
            k2i(i)=h*subs(fi{i},{t,x,y},{ti(j)+h/2,wij(1,j-1)+1/2*k1i(1),wij(2,j-1)+1/2*k1i(2)});
        end
    ...
    for i=1:m
        if j==1
            k3i(i)=h*subs(fi{i},{t,x,y},{ti(j)+h/2,wi0(1)+1/2*k2i(1),wi0(2)+1/2*k2i(2)});
        else
            k3i(i)=h*subs(fi{i},{t,x,y},{ti(j)+h/2,wij(1,j-1)+1/2*k2i(1),wij(2,j-1)+1/2*k2i(2)});
        end
    ...
    for i=1:m
        if j==1
            k4i(i)=h*subs(fi{i},{t,x,y},{ti(j)+h,wi0(1)+k3i(1),wi0(2)+k3i(2)});
        else
            k4i(i)=h*subs(fi{i},{t,x,y},{ti(j)+h,wij(1,j-1)+k3i(1),wij(2,j-1)+k3i(2)});
        end
